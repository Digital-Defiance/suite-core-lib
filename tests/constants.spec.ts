...
describe('Constants Module', () => {
  describe('BACKUP_CODES', () => {
    it('should be defined and have correct structure', () => {
      ...
      expect(BACKUP_CODES).toMatchObject({
        ...
        NormalizedHexRegex: expect.any(RegExp) as RegExp,
        DisplayRegex: expect.any(RegExp) as RegExp,
      });
    });
    ...
    it('should be immutable (frozen)', () => {
      ...
      expect(() => {
        (BACKUP_CODES as Record<string, unknown>).Count = 999;
  ...
  describe('Constants default export', () => {
    ...
    it('should be immutable (frozen)', () => {
      ...
      // Test that the object cannot be modified
      expect(() => {
        (Constants as Record<string, unknown>).AdministratorUser = 'hacker';
      }).toThrow();
    });
