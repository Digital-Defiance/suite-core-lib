...
> = {
  [LanguageCodes.EN_US]: {
    ...
    [SuiteCoreStringKey.Error_UnexpectedErrorInAuthenticateCrypto]: 'Unexpected error in authenticateCrypto',
    ...
    [SuiteCoreStringKey.Error_JwtSecretMustBe64CharHexString]: 'JWT_SECRET must be a 64 character hex string',
    ...
    [SuiteCoreStringKey.Admin_DotEnvFormat]: 'Below are the credentials to add to your API .env file',
  ...
  [LanguageCodes.DE]: {
    ...
    [SuiteCoreStringKey.Error_JwtSecretMustBe64CharHexString]: 'JWT_SECRET muss eine hexadezimale Zeichenkette mit 64 Zeichen sein',
    ...
    [SuiteCoreStringKey.Error_UnexpectedErrorInAuthenticateCrypto]: 'Unerwarteter Fehler in authenticateCrypto',
    ...
    [SuiteCoreStringKey.Admin_DotEnvFormat]: 'Unten sind die Zugangsdaten, die Sie Ihrer API .env-Datei hinzufügen müssen',
    ...
    [SuiteCoreStringKey.Common_CheckingAuthentication]: 'Authentifizierung wird überprüft',
  ...
  [LanguageCodes.ZH_CN]: {
    ...
    [SuiteCoreStringKey.Error_JwtSecretMustBe64CharHexString]: 'JWT_SECRET 必须是 64 字符的十六进制字符串',
    ...
    [SuiteCoreStringKey.Error_UnexpectedErrorInAuthenticateCrypto]: 'authenticateCrypto 中出现意外错误',
    ...
    [SuiteCoreStringKey.Admin_DotEnvFormat]: '以下是需要添加到您的 API .env 文件中的凭据',
  ...
  [LanguageCodes.UK]: {
    ...
    [SuiteCoreStringKey.Error_JwtSecretMustBe64CharHexString]: 'JWT_SECRET повинен бути шістнадцятковим рядком з 64 символів',
    ...
    [SuiteCoreStringKey.Error_UnexpectedErrorInAuthenticateCrypto]: 'Неочікувана помилка в authenticateCrypto',
    ...
    [SuiteCoreStringKey.Admin_DotEnvFormat]: 'Нижче наведено облікові дані, які потрібно додати до файлу API .env',
    ...
    [SuiteCoreStringKey.Common_CheckingAuthentication]: 'Перевірка автентифікації',
