...
export class FecError extends PluginTypedError<
  typeof FecErrorType,
  SuiteCoreStringKey
> {
  constructor(
    ...
    super(
      ...
      type,
      {
        ...
        [FecErrorType.InputDataMustBeUint8Array]:
        ...
        [FecErrorType.ParityDataCountMustBePositive]:
          SuiteCoreStringKey.Error_FecErrorParityDataCountMustBePositive,
        [FecErrorType.ParityDataRequired]:
