...
export const ukrainianStrings: Record<SuiteCoreStringKey, string> = {
    ...
    [SuiteCoreStringKey.Login_UseEmailAddress]: 'Використати адресу електронної пошти',
    ...
    [SuiteCoreStringKey.Settings_EmailHelper]: 'Зміна вашої адреси електронної пошти вимагатиме повторної перевірки. Ми надішлемо лист для підтвердження на нову адресу. Будь ласка, перевірте свою поштову скриньку після збереження змін і дотримуйтесь інструкцій у листі, щоб підтвердити нову адресу.',
