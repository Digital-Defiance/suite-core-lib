...
export const spanishStrings: Record<SuiteCoreStringKey, string> = {
  ...
  [SuiteCoreStringKey.Error_IndexFileNotFoundTemplate]:
    'Archivo de índice no encontrado: {path}',
  [SuiteCoreStringKey.Error_AppDoesNotAppearToBeRunningWithinDistTemplate]:
    'La aplicación no parece estar ejecutándose dentro de un directorio /dist/: {dir}',
  [SuiteCoreStringKey.Error_ValidationFunctionNotRegisteredInAllowlist]:
    'La función de validación no está registrada en la lista permitida',
  [SuiteCoreStringKey.Error_InvalidCertificatePathAfterResolution]:
    'Ruta de certificado inválida después de la resolución',
  [SuiteCoreStringKey.Error_InvalidCertificatePathMustBeAbsolute]:
    'Ruta de certificado inválida: debe ser absoluta y no puede contener ..',
  [SuiteCoreStringKey.Error_InvalidViewsPathEscapesBaseDirectory]:
    'Ruta de vistas inválida: escapa del directorio base',
  [SuiteCoreStringKey.Error_InvalidPathContainsParentDirectoryReference]:
    'Ruta inválida: contiene referencia al directorio padre',
  ...
  [SuiteCoreStringKey.Error_EmptyEnvironmentVariableTemplate]:
    'La variable de entorno {key} está vacía',
  [SuiteCoreStringKey.Error_RecursiveErrorHandlingDetected]:
    'Manejo de errores recursivo detectado',
  [SuiteCoreStringKey.Error_SystemUserMustBeSystemMemberType]:
    'El usuario del sistema debe ser de tipo MemberType.System',
  [SuiteCoreStringKey.Error_JwtSecretMustBe64CharHexString]:
    'JWT_SECRET debe ser una cadena hexadecimal de 64 caracteres',
  [SuiteCoreStringKey.Error_MnemonicHmacSecretMustBe64CharHexString]:
    'MNEMONIC_HMAC_SECRET debe ser una cadena hexadecimal de 64 caracteres',
  [SuiteCoreStringKey.Error_MnemonicEncryptionKeyMustBe64CharHexString]:
    'MNEMONIC_ENCRYPTION_KEY debe ser una cadena hexadecimal de 64 caracteres',
  [SuiteCoreStringKey.Error_AdminMnemonicMustBeValidMnemonicPhrase]:
    'La frase mnemotécnica del administrador debe ser una frase mnemotécnica válida',
  ...
  [SuiteCoreStringKey.Error_SchemaMapFactoryIsRequired]:
    'La fábrica de mapa de esquema es requerida',
  [SuiteCoreStringKey.Error_DatabaseInitFunctionIsRequired]:
    'La función de inicialización de base de datos es requerida',
  [SuiteCoreStringKey.Error_InitResultHashFunctionIsRequired]:
    'La función de hash de resultado de inicialización es requerida',
  [SuiteCoreStringKey.Error_InvalidCspOrHelmetOptionsProvided]:
    'Opciones CSP o Helmet inválidas proporcionadas',
  [SuiteCoreStringKey.Error_ServiceIsNotRegisteredTemplate]:
    'Servicio {key} no registrado',
  ...
  [SuiteCoreStringKey.Validation_ValueMustBeOneOfTheAvailableOptions]:
    'El valor debe ser una de las opciones disponibles',
  [SuiteCoreStringKey.Error_UnexpectedErrorInAuthenticateCrypto]:
    'Error inesperado en authenticateCrypto',
  ...
  [SuiteCoreStringKey.Error_ChildRoleCannotBeASystemRole]:
    'Un rol hijo no puede ser un rol del sistema',
  [SuiteCoreStringKey.Error_ChildRoleCannotBeAnAdminRole]:
    'Un rol hijo no puede ser un rol de administrador',
  ...
  [SuiteCoreStringKey.Admin_NoMongoDbClientFoundFallingBack]:
    'No se encontró cliente MongoDB, usando alternativa',
  [SuiteCoreStringKey.Admin_TransactionFailedTransientTemplate]:
    'Transacción falló (transitorio): {error}',
  [SuiteCoreStringKey.Admin_TransactionTimeoutTemplate]:
    'Tiempo de espera de transacción después de {timeMs}ms',
  ...
  [SuiteCoreStringKey.Admin_Error_FailedToInitializeUserDatabaseTimeoutTemplate]:
    'Error al inicializar base de datos de usuario (tiempo de espera después de {timeMs}ms)',
  [SuiteCoreStringKey.Admin_EnvNotSetTemplate]:
    'Variable de entorno no configurada: {variable}',
  ...
  [SuiteCoreStringKey.Admin_DatabaseInitializedWithOptionsHashTemplate]:
    'Base de datos inicializada con el hash de opciones: {hash}',
  ...
  [SuiteCoreStringKey.Admin_DatabaseDropped]:
    'Colecciones de base de datos eliminadas',
  ...
  [SuiteCoreStringKey.Common_UseMnemonic]:
    'Utilizar únicamente la mnémotechnique',
  ...
  [SuiteCoreStringKey.Error_NoPasswordOrMnemonicProvided]:
    'No se proporcionó contraseña o frase mnemotécnica',
  ...
  [SuiteCoreStringKey.Error_EmailSentTooRecentlyTemplate]:
    'El correo electrónico de verificación fue enviado hace poco. Por favor, espere {EmailTokenResendIntervalMinutes} minutos antes de solicitar otro.',
  ...
  [SuiteCoreStringKey.Error_InvalidEmailTokenType]:
    'Tipo de token de correo electrónico inválido.',
  ...
  [SuiteCoreStringKey.Error_EmailService_NotConfigured]:
    'Servicio de correo electrónico no configurado. Llame a setEmailService() antes de usar el middleware.',
  [SuiteCoreStringKey.Error_FailedToCreateEmailToken]:
    'Error al crear el token de correo electrónico',
  [SuiteCoreStringKey.Error_MustMatchRegexTemplate]:
    '{value} debe coincidir con el formato requerido',
  ...
  [SuiteCoreStringKey.Login_ChallengeGenerated]:
    'Desafío de inicio de sesión generado',
  ...
  [SuiteCoreStringKey.PasswordLogin_Setup_Failure]:
    'Error en la configuración de inicio de sesión por contraseña',
  [SuiteCoreStringKey.PasswordLogin_Setup_NotAvailable]:
    'Inicio de sesión por contraseña no disponible',
  [SuiteCoreStringKey.PasswordLogin_Setup_Success]:
    'Configuración de inicio de sesión por contraseña exitosa',
  ...
  [SuiteCoreStringKey.Settings_EmailHelper]:
    'Cambiar su dirección de correo electrónico requerirá una nueva verificación. Enviaremos un correo electrónico de verificación a la nueva dirección para confirmar. Por favor, revise su bandeja de entrada después de guardar los cambios y siga las instrucciones en el correo electrónico para verificar su nueva dirección.',
  ...
  [SuiteCoreStringKey.Settings_DarkModeSuccess]:
    'Modo oscuro actualizado con éxito',
  ...
  [SuiteCoreStringKey.TokenType_MnemonicRecoveryRequest]:
    'Solicitud de recuperación mnemotécnica',
