...
export const mandarinStrings: Record<SuiteCoreStringKeyValue, string> = {
  ...
  [SuiteCoreStringKey.FakeEmail_Admin_Title]: '模拟邮件（开发）',
  [SuiteCoreStringKey.FakeEmail_Admin_Recipients]: '收件人',
  [SuiteCoreStringKey.FakeEmail_Admin_Subject]: '主题',
  [SuiteCoreStringKey.FakeEmail_Admin_Timestamp]: '时间戳',
  [SuiteCoreStringKey.FakeEmail_Admin_NoRecipients]: '尚未捕获任何邮件。',
  [SuiteCoreStringKey.FakeEmail_Admin_NoEmails]: '该收件人没有邮件。',
  [SuiteCoreStringKey.FakeEmail_Admin_Refresh]: '刷新',
  [SuiteCoreStringKey.FakeEmail_Admin_ClearAll]: '清除全部',
  [SuiteCoreStringKey.FakeEmail_Admin_ClearConfirm]: '清除所有捕获的邮件？',
  ...
  [SuiteCoreStringKey.Registration_PasswordAuthInfo]:
    '您的密码将加密仅存储在此浏览器中的恢复短语。在新设备上登录将需要直接使用您的恢复短语——请将其保存在安全的地方。',
