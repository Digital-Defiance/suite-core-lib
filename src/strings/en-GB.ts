...
export const britishEnglishStrings: Record<SuiteCoreStringKey, string> = {
    ...
    [SuiteCoreStringKey.Settings_EmailHelper]: 'Changing your email address will require re-verification. We will send a verification email to the new address to confirm. Please check your inbox after saving changes and follow the instructions in the email to verify your new address.',
