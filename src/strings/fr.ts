...
export const frenchStrings: Record<SuiteCoreStringKey, string> = {
  ...
  [SuiteCoreStringKey.Error_IndexFileNotFoundTemplate]:
    'Fichier index introuvable : {path}',
  [SuiteCoreStringKey.Error_AppDoesNotAppearToBeRunningWithinDistTemplate]:
    "L'application ne semble pas être exécutée dans un répertoire /dist/",
  [SuiteCoreStringKey.Error_ValidationFunctionNotRegisteredInAllowlist]:
    'Fonction de validation non enregistrée dans la liste autorisée',
  [SuiteCoreStringKey.Error_InvalidCertificatePathAfterResolution]:
    'Chemin de certificat invalide après résolution',
  [SuiteCoreStringKey.Error_InvalidCertificatePathMustBeAbsolute]:
    'Chemin de certificat invalide : doit être absolu et ne peut pas contenir ..',
  ...
  [SuiteCoreStringKey.Error_EmptyEnvironmentVariableTemplate]:
    "La variable d'environnement {key} est vide",
  [SuiteCoreStringKey.Error_RecursiveErrorHandlingDetected]:
    "Gestion d'erreur récursive détectée",
  [SuiteCoreStringKey.Error_SystemUserMustBeSystemMemberType]:
    "L'utilisateur système doit être de MemberType.System",
  [SuiteCoreStringKey.Error_JwtSecretMustBe64CharHexString]:
    'JWT_SECRET doit être une chaîne hexadécimale de 64 caractères',
  [SuiteCoreStringKey.Error_MnemonicHmacSecretMustBe64CharHexString]:
    'MNEMONIC_HMAC_SECRET doit être une chaîne hexadécimale de 64 caractères',
  [SuiteCoreStringKey.Error_MnemonicEncryptionKeyMustBe64CharHexString]:
    'MNEMONIC_ENCRYPTION_KEY doit être une chaîne hexadécimale de 64 caractères',
  [SuiteCoreStringKey.Error_AdminMnemonicMustBeValidMnemonicPhrase]:
    "La phrase mnémonique d'administrateur doit être une phrase mnémonique valide",
  [SuiteCoreStringKey.Error_MemberMnemonicMustBeValidMnemonicPhrase]:
    'La phrase mnémonique de membre doit être une phrase mnémonique valide',
  ...
  [SuiteCoreStringKey.Error_ApiRouterFactoryIsRequired]:
    'La fabrique de routeur API est requise',
  [SuiteCoreStringKey.Error_SchemaMapFactoryIsRequired]:
    'La fabrique de carte de schéma est requise',
  [SuiteCoreStringKey.Error_DatabaseInitFunctionIsRequired]:
    "La fonction d'initialisation de la base de données est requise",
  [SuiteCoreStringKey.Error_InitResultHashFunctionIsRequired]:
    "La fonction de hachage du résultat d'initialisation est requise",
  [SuiteCoreStringKey.Error_ServiceIsNotRegisteredTemplate]:
    'Service {key} non enregistré',
  ...
  [SuiteCoreStringKey.Validation_ValueMustBeOneOfTheAvailableOptions]:
    "La valeur doit être l'une des options disponibles",
  [SuiteCoreStringKey.Error_UnexpectedErrorInAuthenticateCrypto]:
    'Erreur inattendue dans authenticateCrypto',
  ...
  [SuiteCoreStringKey.Error_LengthIsInvalidType]:
    'La longueur est de type invalide',
  ...
  [SuiteCoreStringKey.Admin_NoMongoDbClientFoundFallingBack]:
    "Aucun client MongoDB trouvé, utilisation de l'alternative",
  [SuiteCoreStringKey.Admin_TransactionFailedTransientTemplate]:
    'Transaction échouée (transitoire): {error}',
  [SuiteCoreStringKey.Admin_TransactionTimeoutTemplate]:
    "Délai d'attente de transaction après {timeMs}ms",
  ...
  [SuiteCoreStringKey.Admin_Error_FailedToInitializeUserDatabaseTimeoutTemplate]:
    "Échec de l'initialisation de la base de données utilisateur (délai d'attente après {timeMs}ms)",
  [SuiteCoreStringKey.Admin_EnvNotSetTemplate]:
    "Variable d'environnement non définie: {variable}",
  ...
  [SuiteCoreStringKey.Admin_DatabaseInitializedWithOptionsHashTemplate]:
    'Base de données initialisée avec le hachage des options : {hash}',
  ...
  [SuiteCoreStringKey.BackupCodeRecovery_Login]:
    'Connexion avec le code de sauvegarde',
  ...
  [SuiteCoreStringKey.BackupCodeRecovery_Title]:
    'Connexion par code de sauvegarde',
  ...
  [SuiteCoreStringKey.Common_UseMnemonic]:
    'Utiliser uniquement la mnémotechnique',
  ...
  [SuiteCoreStringKey.Email_TokenFailedToSend]:
    "Échec de l'envoi du jeton par e-mail",
  ...
  [SuiteCoreStringKey.Error_ChallengeError]:
    'Erreur lors de la génération du défi',
  ...
  [SuiteCoreStringKey.Error_EmailSentTooRecentlyTemplate]:
    "Jeton d'e-mail envoyé trop récemment. Veuillez réessayer dans ${timeRemaining} secondes.",
  ...
  [SuiteCoreStringKey.Error_InvalidEmailTokenType]:
    "Type de jeton d'email invalide.",
  ...
  [SuiteCoreStringKey.Error_MustMatchRegexTemplate]:
    '{value} doit correspondre au format requis',
  [SuiteCoreStringKey.Error_EmailService_NotConfigured]:
    "Service de messagerie non configuré. Appelez setEmailService() avant d'utiliser le middleware.",
  [SuiteCoreStringKey.Error_FailedToCreateEmailToken]:
    "Échec de la création du jeton d'email",
  ...
  [SuiteCoreStringKey.PasswordLogin_Setup_Failure]:
    'Échec de la configuration de la connexion par mot de passe',
  [SuiteCoreStringKey.PasswordLogin_Setup_NotAvailable]:
    'Connexion par mot de passe non disponible',
  [SuiteCoreStringKey.PasswordLogin_Setup_Success]:
    'Configuration de la connexion par mot de passe réussie',
  ...
  [SuiteCoreStringKey.RemoveMember_Unauthorized]:
    'Non autorisé à supprimer un membre',
  ...
  [SuiteCoreStringKey.Settings_DarkModeSuccess]:
    'Mode sombre mis à jour avec succès',
  ...
  [SuiteCoreStringKey.TokenType_MnemonicRecoveryRequest]:
    'Demande de récupération mnémonique',
  ...
  [SuiteCoreStringKey.Validation_InvalidPassword]:
    'Mot de passe invalide ou incorrect',
  ...
  [SuiteCoreStringKey.Validation_InvalidUserIdTemplate]:
    "ID d'utilisateur invalide: {detail}",
  [SuiteCoreStringKey.Validation_IsMemberBoolean]:
    'isMember doit être un booléen',
